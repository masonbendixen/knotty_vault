...
# AWS Billing Alert Setup ($75 Monthly Alarm)

## Goal

Create a billing alarm that emails me if estimated AWS charges exceed $75/month.

---

# 1. Enable Billing Metrics

> Must be done using the AWS root account.

- Log into AWS as the root user
- Open:
  - Billing and Cost Management
- In the left sidebar:
  - Account
  - or Billing Preferences
- Find:
...
- It may take several minutes or hours before metrics appear in CloudWatch

---

# 2. Allow IAM Users to Access Billing

> Also requires root account.

- In Billing settings/account page
- Find:
...
This allows AdministratorAccess IAM users to access billing data.

---

# 3. Create SNS Email Notification Topic
...
- Open the new `billing-alerts` topic
- Click:
  - Create subscription
...
- Check email inbox
- Open AWS SNS confirmation email
- Click:
  - Confirm subscription

---

# 6. Open CloudWatch in us-east-1

## Important

Billing alarms ONLY work in:
...
Meaning:
- alert if estimated monthly charges exceed $75

---

# 10. Attach Email Notification
...
Create smaller early-warning alarms too:
...
- Billing alarms are not instant
  - may lag by several hours
- Alarm only sends alerts
  - does NOT automatically stop resources
- Root account should only be used for:
  - billing
  - account recovery
  - rare administrative tasks
- Daily usage should use IAM admin user with MFA
