...
- **OQ-PA-2.** Is the requirement set + hierarchy keyed on the **class** or the **class_instances product**? Pricing lives on the product (Phase-1 redesign); requirements feel class-level (they describe the offering, not the run's product). *Leaning:* requirements on the **class**, pricing on the product — confirm.
